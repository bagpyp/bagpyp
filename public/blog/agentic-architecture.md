...
<p>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/images/blog/agentic-architecture/img/c_prime.svg" width="600" alt="
    graph LR
    U1 -- A.chat --> Q1((q1^(i)))
    Q1 -- Ti --> R1((r1^(i)))
    R1 -- A.chat* --> V1((v1))
...
where $m$ is taken to be the number of total calls made throughout a user-agent interaction. A more formal treatment for such objects can be found in the [above](./algebra.md). 
...
<p>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/images/blog/agentic-architecture/img/c_prime_graph.svg" width="600" alt="
    graph LR
        u1 --> A
        A --> q1_i^i
        q1_i^i --> Ti
...
More complicated combinations of interactions within cycles can be depicted in a similar way. Consider the 5 cycles in the example below
  


<p>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/images/blog/agentic-architecture/img/h_pp.svg" width="600" alt="
    graph TD
        subgraph c1
            u1 --> A
            A --> v1
...
<p>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/images/blog/agentic-architecture/img/c_prime_node.svg" width="600" alt="
    graph LR
        A(u1,v1) --> Ti(q1,r1)
    ">
</p>
...
<p>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/images/blog/agentic-architecture/img/h_pp_node.svg" width="600" alt="
